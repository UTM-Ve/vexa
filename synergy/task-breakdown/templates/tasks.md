...
commit: true                    # commit the task files into this workspace's git history
...
# code; edit this rule to change WHAT counts as a task — no redeploy needed.
task_rules: >
...
---
<!-- Steering for the task-breakdown stage — natural language: what counts as a commitment in YOUR
...
date in its frontmatter; the whole breakdown is indexed at `kg/entities/meeting/<meeting-id>.tasks.json`.
